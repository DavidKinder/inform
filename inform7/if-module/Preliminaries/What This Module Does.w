...
@h So many features.
This module consists entirely of features, and when they are all inactive,
...
- //Chapter 2: Bibliographic Data// is a single feature, "bibliographic data".
...
- //Chapter 4: Actions// is the single feature "actions", which provides a
...
- //Chapter 5: Command Parser// is the single feature "parsing", and
